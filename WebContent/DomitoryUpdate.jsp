							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												...
												action="DomitoryUpdateSave.action"
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td width="67%"><input name="Domitory_ID" type="text"
															...
															value="<s:property value='cnbean.Domitory_ID'/>"></td>
													</tr>
													<tr>
															...
															id="Domitory_BuildingID">
																...
																<s:iterator id="aa" value="list">
																	<option value="${Building_ID}"
																		<s:if test="cnbean.Domitory_BuildingID==Building_ID">selected</s:if>>${Building_Name}</option>
																</s:iterator>
														</select></td>
													</tr>
													<tr>
														...
														<td><input name="Domitory_Name" type="text"
															...
															value="<s:property value='cnbean.Domitory_Name'/>"></td>
													</tr>
													<tr>
														<td height="30" align="right"><span
														...
														<td><input name="Domitory_Type" type="text"
															...
															value="<s:property value='cnbean.Domitory_Type'/>"></td>
													</tr>
													<tr>
														<td height="30" align="right"><span
														...
														<td><input name="Domitory_Number" type="text"
															...
															value="<s:property value='cnbean.Domitory_Number'/>"></td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color: red;">*</span>电话：</td>
														<td><input name="Domitory_Tel" type="text"
															class="text2" id="Domitory_Tel"
															value="<s:property value='cnbean.Domitory_Tel'/>"></td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
