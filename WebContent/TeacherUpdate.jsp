							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												name="form1" method="post" action="TeacherUpdateSave.action"
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td><input name="Teacher_Username" type="text"
															...
															value="<s:property value='cnbean.Teacher_Username'/>"></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><input name="Teacher_Name" type="text"
															...
															value="<s:property value='cnbean.Teacher_Name'/>"></td>
													</tr>
													<tr>
														<td height="30" align="right"><span
														...
														<td><select name="Teacher_Sex" id="Teacher_Sex">
																...
																<option value="男"
																	<s:if test='cnbean.Teacher_Sex=="男"'>selected</s:if>>男
																</option>
																<option value="女"
																	<s:if test='cnbean.Teacher_Sex=="女"'>selected</s:if>>女
																</option>
														</select></td>
													</tr>
													<tr>
														...
														<td><input name="Teacher_Tel" type="text"
															...
															value="<s:property value='cnbean.Teacher_Tel'/>"></td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
