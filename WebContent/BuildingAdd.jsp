							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="30" background="Images/mainMenuBg.jpg"
											style="padding-left: 25px;">添加楼宇</td>
									</tr>
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												name="form1" method="post" action="BuildingAddSave.action"
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														<td height="30" align="right"><span
															style="color: red;">*</span>名称：</td>
														<td><input name="Building_Name" type="text"
															class="text2" id="Building_Name"></td>
													</tr>
													<tr>
														<td height="30" align="right">简介：</td>
														<td><textarea name="Building_Introduction"
																id="Building_Introduction" cols="45" rows="5"></textarea></td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
														<td><input type="submit" name="button" id="button"
															value="添加楼宇"> &nbsp;&nbsp; <input type="button"
