							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="30" background="Images/mainMenuBg.jpg"
											style="padding-left: 25px;">楼宇管理</td>
									</tr>
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												name="form1" method="post" action="BuildingManager.action">
												<table width="100%%" border="0" cellspacing="0"
													cellpadding="0">
													<tr>
														<td width="28%" height="30" style="padding-left: 20px;">
															功能导航： <a href="BuildingAdd.jsp">添加楼宇</a>
														</td>
														<td width="72%">名称： <input name="SearchKey"
															type="text" class="text1" id="SearchKey"> <input
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<s:iterator id="aa" value="list">
													<tr align="center">
														...
														<td align="center"><a
															href="TBManager.action?Building_ID=${Building_ID}">管理员</a>
															<a
															href="BuildingUpdate.action?Building_ID=${Building_ID}">修改</a>
															<a href="BuildingDel.action?Building_ID=${Building_ID}"
															onClick="return confirm('确定要删除该楼宇吗？')">删除</a></td>
													</tr>
												</s:iterator>
											</table></td>
									</tr>
