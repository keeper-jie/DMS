							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="30" background="Images/mainMenuBg.jpg"
											style="padding-left: 25px;">修改楼宇</td>
									</tr>
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												name="form1" method="post"
												action="BuildingUpdateSave.action"
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td width="67%"><input name="Building_ID" type="text"
															...
															value="<s:property value='cnbean.Building_ID'/>"></td>
													</tr>
													<tr>
														...
														<td><input name="Building_Name" type="text"
															...
															value="<s:property value='cnbean.Building_Name'/>"></td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color: red;">*</span>联系电话：</td>
														<td><textarea name="Building_Introduction"
																id="Building_Introduction" cols="45" rows="5"><s:property
																	value='cnbean.Building_Introduction' /></textarea></td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
														<td><input type="submit" name="button" id="button"
															value="修改楼宇"> &nbsp;&nbsp; <input type="button"
