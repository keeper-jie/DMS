...
public class StudentDao {
	...
	public StudentBean GetFirstBean(String strwhere) {
		String sql = "select * from Student,Domitory,Building where Student_DomitoryID=Domitory_ID and Domitory_BuildingID=Building_ID and "
				+ strwhere;
		// test
		System.out.println(sql);
		Statement stat = null;
	...
	public void Add(StudentBean cnbean) {
		...
		sql += ") values(";
		sql += "'" + cnbean.getStudent_DomitoryID() + "','" + cnbean.getStudent_Username() + "','"
				+ cnbean.getStudent_Password() + "','" + cnbean.getStudent_Name() + "','" + cnbean.getStudent_Sex()
				+ "','" + cnbean.getStudent_Class() + "','" + cnbean.getStudent_State() + "'";
		sql += ")";
		// test
		System.out.println(sql);
		Statement stat = null;
