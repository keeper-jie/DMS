...
public class StudentQC extends ActionSupport {
	...
	/**
	 * 	连接Student,Domitory查询StudentDao
	 */
	...
	public String execute() throws Exception {
		...
		//查询学生信息（select * from Student,Domitory,Building where Student_DomitoryID=Domitory_ID and Domitory_BuildingID=Building_ID and）
